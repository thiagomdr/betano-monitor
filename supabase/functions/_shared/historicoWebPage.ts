...
export const PAINEL_BUILD_ID = 'futebol-gols-db-backfill-20260709';
...
<body>
  ...
  <script type="module">
    ...
    function renderTabelaHistoricoFutebol(historicoJanela, leiturasPorPartida, resumoJanela) {
    ...
    function renderEstatisticasFutebol(payload) {
      const { partidas, agenda, stats, aoVivoJson, historicoJanela, leiturasPorPartida, resumoJanela } = payload;
      ...
      elConteudo.innerHTML = '<div class="futebol-stats-wrap">' + resumo +
        ...
        renderTabelaHistoricoFutebol(historico, leiturasMap, resumoJanela) +
      '</div>';
